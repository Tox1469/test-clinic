...
const PATIENTS = [
  { nome: 'Maria da Silva Santos', cpf: '123.456.789-00', telefone: '(11) 99876-5432', convenio: 'Unimed', ultima: '15/03/2026' },
  { nome: 'Joao Carlos Oliveira', cpf: '987.654.321-00', telefone: '(11) 98765-4321', convenio: 'SUS', ultima: '20/03/2026' },
  { nome: 'Ana Paula Ferreira', cpf: '456.789.123-00', telefone: '(21) 97654-3210', convenio: 'Amil', ultima: '18/04/2026' },
  { nome: 'Carlos Eduardo Souza', cpf: '321.654.987-00', telefone: '(31) 96543-2109', convenio: 'Bradesco Saude', ultima: '10/04/2026' },
  { nome: 'Lucia Helena Martins', cpf: '654.987.321-00', telefone: '(41) 95432-1098', convenio: 'Particular', ultima: '05/04/2026' },
]
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-800/50">
                <tr>
                  ...
                  <th className="px-4 py-2.5 text-left text-xs font-medium text-gray-500">Ultima Consulta</th>
                </tr>
              </thead>
              <tbody>
                {PATIENTS.map((p, i) => (
                  <tr key={i} className="border-b border-gray-800/50 last:border-0 hover:bg-gray-800/30 cursor-pointer">
                    ...
                    <td className="px-4 py-3 text-gray-400">{p.telefone}</td>
                    <td className="px-4 py-3">
                      <span className="text-xs px-2 py-0.5 rounded-full bg-gray-800 text-gray-300">{p.convenio}</span>
                    </td>
                    <td className="px-4 py-3 text-gray-500 text-xs">{p.ultima}</td>
                  </tr>
                ))}
              </tbody>
            </table>
